...
- **THEN** the system should:
  ...
  - Test command chaining and pipeline operations with real stdin/stdout
...
- **THEN** the system should:
  ...
  - Include pipeline data transformation and filtering scenarios
...
- [ ] Task 2: CLI command integration testing (AC: 2)
  ...
  - [ ] Create pipeline testing with real process execution and stdin/stdout
...
- **Pipeline Testing**: Real stdin/stdout with command chaining [Source: architecture.md#pipeline-pattern]
...
- Genuine stdin/stdout redirection with shell pipes for pipeline testing
...
- **Pipeline Testing**: Real shell pipe operations between processes
...
- **PipelineTestManager**: Command chaining with real stdin/stdout piping
...
- Pipeline operation testing with actual stdin/stdout redirection
